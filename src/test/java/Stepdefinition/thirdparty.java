...
public class thirdparty extends Generic_function{
...
public void launches_url_for_third_party() throws IOException {
	try {
	browser_launch();
	s= Dataiter();
	browser_wait(120000);
...
public void able_to_click_on_login_button_for_third_party() throws IOException {
	try {
		click("first_login");
		Thread.sleep(3000);
		browser_wait(1000);
...
@Then("lands on login page for third party")
   public void lands_on_login_page_for_third_party() throws IOException {
		try {
...
@When("hits login button and lands on third party dashboard")
...
public void third_party_hits_on_the_pending_buttion() throws IOException {
	try {
...
public void third_party_can_view_the_pending_list_of_applications() throws IOException {
	try {
